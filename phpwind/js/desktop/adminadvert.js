var imgAdverClass = {
	...
	template : function(next){
		...
		var td1 = this.createTD('图片地址 * <span class="gray">( 外链以http://开头 )</span>');
		var td2 = this.createTD('<input type="text" class="input" size="60" name="config[url]['+next+']" value=""> <a href="javascript:;">[移除]</a>');
		tr1.appendChild(td1);
		tr1.appendChild(td2);
		...
		var td3 = this.createTD('图片链接 * <span class="gray">( 外链以http://开头 )</span>');
		var td4 = this.createTD('<input type="text" class="input" size="60" name="config[link]['+next+']" value="http://">');
		tr2.appendChild(td3);
		tr2.appendChild(td4);
