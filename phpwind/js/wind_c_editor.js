...
function insertImage(cmdID) {
	...
	menu_editor.innerHTML = '<div style="width:340px;"><h4><div class="fr" style="cursor:pointer;" onclick="closep();" title="关闭"><img src='+imgpath+'/close.gif></div>'+I18N['insertImage']+'</h4><table width="100%"><tbody><tr><td width="25%">'+I18N['mediaurl']+'</td><td><input class="input" type="text" id="mediaurl" size="32" /></td></tr><tr><td> </td><td><input class="btn" type="button" onclick="return insertImageToPage();" value="'+I18N['submit']+'" /></td></tr></tbody></table></div>';
...
function ShowSelect(cmdID) {
	...
	for (var i in options) {
		if (i != 'default' && i != 'event') {
			html += "<li"+(cmdID=='fontname' ? ' style="font-family:'+options[i]+';"' : '')+"><a unselectable=\"on\" href=\"javascript:\" style=\"font-size:"+i+"ex ;line-height:100%\" onclick=\"return editor.GetSelectedValue('"+cmdID+"','"+options[i]+"');\">"+i+"</a></li>";
		}
	}
	html += '</ul>';
	menu_editor.innerHTML = html;
...
function rming(cmdID) {
	editor.saveRange();
	var menu_editor = getObj("menu_editor");
	menu_editor.innerHTML = '<div style="width:320px;"><h4><div class="fr" style="cursor:pointer;" onclick="closep();" title="关闭"><img src='+imgpath+'/close.gif></div>'+I18N['insertmedia']+'</h4><table width="100%"><tbody><tr><td width="25%">'+I18N['mediaurl']+'</td><td><input class="input" type="text" id="mediaurl" size="32" /></td></tr><tr><td>'+I18N['mediatype']+'</td><td><input type="radio" name="mediatype" id="mediatype1" value="1"> rm <input type="radio" name="mediatype" id="mediatype2" value="2" checked> wmv <input type="radio" name="mediatype" id="mediatype3" value="3"> mp3 <input type="radio" name="mediatype" id="mediatype4" value="4"> flash</td></tr><tr><td>'+I18N['medialength']+'</td><td><input class="input" type="text" id="medialength" value="314" size="6" />&nbsp;'+I18N['mediawidth']+'&nbsp;&nbsp;<input class="input" type="text" id="mediawidth" value="256" size="6" />&nbsp;'+I18N['mediaheight']+'</td></tr><tr><td>'+I18N['mediaplay']+'</td><td><input type="checkbox" id="midiaauto" />'+I18N['mediaauto']+'</td></tr><tr><td> </td><td><input class="btn" type="button" onclick="return insertmedia();" value="'+I18N['submit']+'" /></td></tr></tbody></table></div>';
