...
if ($action == "topped") {
	...
	$t_count = $db->get_value("SELECT COUNT(*) AS count FROM pw_poststopped WHERE tid = " . pwEscape($tid));
	$db->update("UPDATE pw_threads SET topreplays = $t_count WHERE tid=" . pwEscape($tid));
