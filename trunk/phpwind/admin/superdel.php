...
function numofpage_t($count,$page,$numofpage,$url,$max=null,$ajaxurl='') {
	...
	if ($numofpage <= 1 || !is_numeric($page)) {
		...
		$mao && $mao = '#'.$mao;
		$pages = "<div class=\"pages cc\"><a href=\"javascript:;\" class=\"b\" onclick=\"superdel.submit(1);return false;\" >&laquo;</a>";
		...
		$pages .= "<a href=\"javascript:;\" class=\"b\" onclick=\"superdel.submit($numofpage);return false;\">&raquo;</a><span class=\"pagesone\">Pages: $page/$total&nbsp; &nbsp; &nbsp;Go <input type=\"text\" size=\"3\" onkeydown=\"javascript: if(event.keyCode==13){superdel.submit(this.value); return false;}\"></span></div><div class=\"c\"></div>";
		return $pages;
	}
}
?>