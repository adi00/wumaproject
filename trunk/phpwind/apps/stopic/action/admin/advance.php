...
if ('save' == $jobact) {
	...
	InitGP(array("stopic_title", "layout_set", "is_new_bg", "bg_id", "seo_keyword", "seo_desc", "is_display_style"));
	$bg_id = intval($bg_id);
	...
	ObHeader($basename."&job=$job&stopic_id=$stopic_id&display=".$is_display_style);
} else {
	InitGP(array("stopic_id", "category_id", "display"), null, 2);
