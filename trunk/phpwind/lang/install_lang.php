...
$lang = array(
	...
	'hacklist'			=> '插件列表',
	'have_file'			=> '<h4><span class="fr h4-zy">您已经安装过 PHPWind Forums，如需重新安装，请删除此文件（{#bbsurl}/data/{#lockfile}）再进行安装</span><span class="fl"><img src="lang/images/jinggao.gif" align="absmiddle"/> </span></h4>',
	'have_upfile'		=> '<h4><span class="fr h4-zy">您已经升级过 PHPWind Forums，如需重新升级，请删除此文件（{#bbsurl}/data/{#lockfile}.lock）再进行后续操作</span><span class="fl"><img src="lang/images/jinggao.gif" align="absmiddle"/> </span></h4>',
	...
	'success_install'	=> '恭喜您，您的 PHPWind Forums v{#wind_version} 已经安装成功！',
	'success_repair'	=> '恭喜您，您的 PHPWind Forums v{#wind_version} 已经更新成功！',
	'success_upto'		=> '恭喜您，您的 PHPWind Forums v{#wind_version} 已经升级成功！',
	...
	'left_info'			=> '<dt style="margin:0;">更新记录</dt>
        ...
        <dt>帮助文档</dt>
        <dd style="padding-top:5px;"><a href="http://www.phpwind.net/read-htm-tid-836771.html" target="_blank">安装教程</a></dd>
		<dd><a href="http://www.phpwind.net/read-htm-tid-839259.html" target="_blank">升级教程</a></dd>
