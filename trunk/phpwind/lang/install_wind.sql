...
DROP TABLE IF EXISTS pw_filter_record;
CREATE TABLE pw_filter_record (
  id int(10) unsigned NOT NULL auto_increment,
  scantime int(10) unsigned NOT NULL default '0',
...
INSERT INTO pw_postcate (pcid, sign, name, ifable, vieworder, viewright, adminright) VALUES(2, 'buy' , '活动', 1, 0, '', '');
