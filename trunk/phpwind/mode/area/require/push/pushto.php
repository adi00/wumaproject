...
if ($step == 2) {
	...
	InitGP(array('subject','content','titleid','offset','index','invokename','starttime','endtime','title1','title2','title3','title4','titletime'));
	...
	if ($custom) {
		...
		$invokeService->insertPushData(array('invokename'=>$invoke,'invokepieceid'=>$mInvoke['id'],'fid'=>$cateid,'loopid'=>$loopid,'editor'=>$windid,'offset'=>$offset-1,'starttime'=>$starttime,'endtime'=>$endtime,'data'=>$custom,'titlecss'=>$titlecss));
