...
'bbs_open'					=> '由于数据操作较大，请先关闭论坛后，继续操作，'
								. '<a href=$GLOBALS[admin_file]?adminjob=settings&type=bbsset target=blank style="color:blue">进入“核心设置-常规设置”</a>！',
...
'search_keyword_empty'		    => '查找的关键字找不到贴子',
...
/****************APP增加语言****************/
    'filtermsg_thread_title'		=> '【敏感词】您表发的帖子包含敏感内容，不能发布!',
	'filtermsg_thread_content'		=> '您发布的帖子：{$L[subject]}，包含敏感内容不能发布，请及时修改。\n\n'
									. '<a style="color:blue;" href="read.php?tid={$L[tid]}">现在就去修改</a>\n',
    'filtermsg_post_title'			=> '【敏感词】您表发的回复包含敏感内容，不能发布!',
	'filtermsg_post_content'		=> '您发布的回复：{$L[subject]}，包含敏感内容不能发布，请及时修改。\n\n'
									. '<a style="color:blue;" href="read.php?tid={$L[tid]}">现在就去修改</a>\n',
