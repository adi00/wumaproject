...
$lang['right'] = array (
	'basic' => array(
		...
		'userbinding' => array(
			'title'	=> '可绑定其他帐号',
			'html'	=> '<input type="radio" value="1" name="group[userbinding]" $userbinding_Y />是
			<input type="radio" value="0" name="group[userbinding]" $userbinding_N />否'
		),
		'allowread'	=> array(
			'title'	=> '可浏览帖子',
	...
	'read'	=> array(
		...
		'allowmodelid'	=> array(
			'title'	=> '可发分类信息贴',
			'html'	=> '<input type="radio" value="1" name="group[allowmodelid]" $allowmodelid_Y />是
			<input type="radio" value="0" name="group[allowmodelid]" $allowmodelid_N />否'
		),
		'allowpcid'	=> array(
			'title'	=> '可发团购活动帖',
			'html'	=> '<input type="checkbox" name="group[allowpcid][]" value="1" $allowpcid_sel[1] />团购 
			<input type="checkbox" name="group[allowpcid][]" value="2" $allowpcid_sel[2] />活动'
		),
		'htmlcode'	=> array(
			'title'	=> '可发html帖',
	...
	'systemforum' => array(
		...
		'topped'	=> array(
			...
			<input type="radio" value="3" name="group[topped]" $topped_3 />版块置顶,分类置顶,总置顶<br />
			<input type="radio" value="4" name="group[topped]" $topped_4 />任意版块置顶'
		),
		'replayorder' => array(
			'title'	  => '可设置帖子回复显示顺序',
			'html'	  => '<input type="radio" value="1" name="group[replayorder]" $replayorder_Y />是
			<input type="radio" value="0" name="group[replayorder]" $replayorder_N />否',
		),
		'digestadmin'	=> array(
			'title'	=> '前台精华管理权限',
		...
		'pushadmin'	=> array(
			'title'	=> '前台提前管理权限',
			'html'	=> '
			<input type="radio" value="1" name="group[pushadmin]" $pushadmin_Y onclick="showGroup(\'pushtimeinput\',1)" />是
			<input type="radio" value="0" name="group[pushadmin]" $pushadmin_N onclick="showGroup(\'pushtimeinput\',0)" />否&nbsp;
			<span $ptdisplay id="pushtimeinput" ><input type="text" value="$pushtime" name="group[pushtime]" size="4" /> 小时（时间上限,留空或0表示不限制）</span>'
		),
		'coloradmin'	=> array(
			'title'	=> '前台加亮管理权限',
		...
		'replaytopped' => array(
			'title'    => '前台贴内置顶管理权限',
			'html'	   => '<input type="radio" value="1" name="group[replaytopped]" $replaytopped_Y />是
			<input type="radio" value="0" name="group[replaytopped]" $replaytopped_N />否',
		),
		'tpctype'	=> array(
		...
		'overprint'	=> array(
			...
			'html'	=> '<input type="radio" value="1" name="group[overprint]" $overprint_Y />是
			<input type="radio" value="0" name="group[overprint]" $overprint_N />否'
		)
	)
);
?>